...
meta_analysis_figures - Medical AI Project
...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/meta-analysis-figures.git
cd meta-analysis-figures
```
...
1. **构建镜像**
```bash
docker build -t meta-analysis-figures .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name meta-analysis-figures meta-analysis-figures
```
...
- **项目主页**: https://github.com/MoKangMedical/meta-analysis-figures
- **问题反馈**: https://github.com/MoKangMedical/meta-analysis-figures/issues
